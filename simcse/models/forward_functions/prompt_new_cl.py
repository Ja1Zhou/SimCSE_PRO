...
def train_forward_function(
    ...
    hidden_size = pooler_output_1.size(-1)
    ...
    # Hard negative
    z3 = pooler_output_1[:, 2] if num_sent == 3 else None
    z3_ = pooler_output_2[:, 2] if num_sent == 3 else None
    ...
    cos_sim_ = new_cl_util(cls, num_sent, batch_size, hidden_size, z1_, z2_, z3_)
    inter_cos = new_cl_util(cls, num_sent, batch_size, hidden_size, z1, z1_, z3_)
